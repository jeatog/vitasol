...
enum Textos {
    ...
    enum Ajustes {
        ...
        static let diasRecordatorio:        LocalizedStringKey = "ajustes.dias_recordatorio"
    ...
    enum Logros {
        ...
        static let racha14Titulo:       LocalizedStringKey = "logro.racha_14_titulo"
        static let racha14Desc:         LocalizedStringKey = "logro.racha_14_desc"
        ...
        static let racha60Titulo:       LocalizedStringKey = "logro.racha_60_titulo"
        static let racha60Desc:         LocalizedStringKey = "logro.racha_60_desc"
        static let centenarioTitulo:    LocalizedStringKey = "logro.centenario_titulo"
        static let centenarioDesc:      LocalizedStringKey = "logro.centenario_desc"
        static let diezHorasTitulo:     LocalizedStringKey = "logro.diez_horas_titulo"
        static let diezHorasDesc:       LocalizedStringKey = "logro.diez_horas_desc"
        static let madrugadorTitulo:    LocalizedStringKey = "logro.madrugador_titulo"
        static let madrugadorDesc:      LocalizedStringKey = "logro.madrugador_desc"
        static let medioDiaTitulo:      LocalizedStringKey = "logro.mediodia_titulo"
        static let medioDiaDesc:        LocalizedStringKey = "logro.mediodia_desc"
        static let trotamundosTitulo:   LocalizedStringKey = "logro.trotamundos_titulo"
        static let trotamundosDesc:     LocalizedStringKey = "logro.trotamundos_desc"
        static let uvExtremoTitulo:     LocalizedStringKey = "logro.uv_extremo_titulo"
        static let uvExtremoDesc:       LocalizedStringKey = "logro.uv_extremo_desc"
        static let finDeSemanaTitulo:   LocalizedStringKey = "logro.fin_de_semana_titulo"
        static let finDeSemanaDesc:     LocalizedStringKey = "logro.fin_de_semana_desc"
    }
